...
![](Sketch%20-%20take%20home%20exercise%2002.jpg) \### 4.3 The Makeover Result
...
p1 <-ggplot(combined_ds, 
   ...
   geom_density_ridges(scale = 0.9,
    ...
    geom_text(data = median_values, 
            ...
            hjust = -0.4, vjust = -3, color = "black", size = 3) +
  ...
  annotate("text", x=2300, y=0.7, label=paste0("Singapore's Median:",median(combined_ds$`Unit Price ($ PSF)`)), 
           size=3, color="red") +
