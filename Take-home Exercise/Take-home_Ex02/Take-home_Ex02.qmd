...
combined_ds$`Planning Region` <- factor(combined_ds$`Planning Region` , levels = c("North", "East", "West", "North East", "Central"), ordered = TRUE)
...
p1 <- ggplot(combined_ds, 
  ...
  xlim(0, 4000) # Limit x-axis to 4000
