...
4.  Sub markets to focus on could be the following: - For Land `Type of Sale`: Detached House, Semi-Detached House, and Terrace House. - For Strata `Type of Sale`: Apartment, Condominium, and Executive Condominium.
